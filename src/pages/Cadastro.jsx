...
export default function Cadastro() {
  ...
  const inputCls = 'w-full rounded-lg border border-gray-300 px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 outline-none transition'
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1 text-sm">Crie sua conta</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              />
              <span className={`absolute right-3 top-1/2 -translate-y-1/2 text-xs ${username.length >= MAX ? 'text-red-400' : 'text-gray-400'}`}>
                {username.length}/{MAX}
              </span>
            </div>
          </div>
